...
map('n', 'ga', '<cmd>lua vim.lsp.buf.code_action()<cr>') --------- Go action, code action
map('n', 'gr', '<cmd>lua vim.lsp.buf.rename()<cr>') -------------- Go rename, rename variable
...
map('n', 'D', '<cmd>lua vim.lsp.buf.hover()<cr>') ---------------- Hover function detail
